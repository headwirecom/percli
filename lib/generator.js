        ...
        if (propName !== 'children') {
            ...
            if(props['x-source'] == 'inject') {
                ...
                if(props['x-form-type'] === ('collection')) {
                    if (Object.keys(props['properties']).length > 1 || props['x-form-multifield'].equals(true)
                        || props['x-form-multifield'].equals("true")) {
    ...
    for(var prop in properties) {
        ...
        if (propName !== 'children' && (customGetters === null || !customGetters.includes('public String get' + getterName + '()'))) {
            ...
            if(props['x-source'] == 'inject') {
                inject += '\t/* '+JSON.stringify(props)+' */\n'
                if(props['x-form-type'] === ('collection')) {
                     if (Object.keys(props['properties']).length > 1 || props['x-form-multifield'] === true) {
