...
function htmltovueAll(container, compile, deploy, dialog, model, nosampleempty, vue, category) {
    if (!category) {
        category = 'fragments'
    }
    ...
    for(let i = 0; i < components.length; i++) {
        ...
        htmltovue(components[i], container, compile, deploy, dialog, model, nosampleempty, vue, category)
    }
    if(compile) {
...
function htmltovue(name, container, compile, deploy, dialog, model, nosampleempty, vue, category) {
