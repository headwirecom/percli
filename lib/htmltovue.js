...
function htmltovueAll(container, compile, deploy, dialog, model, vue) {
...
function htmltovue(name, container, compile, deploy, dialog, model, vue) {
    ...
    const functionsAugmentPath = path.join(process.cwd(), 'fragments', 'functions.js')
