...
/**
   ...
   * @param {string} nosampleempty - command argument that if exists will omit the sample-empty.json file
   * @param {string} category - command argument that will tell whether to convert a component or object
*/
function htmltovueAll(container, compile, deploy, dialog, model, vue, nosampleempty, category) {
    if (!category) {
        category = 'fragments'
    }
    ...
    for(let i = 0; i < components.length; i++) {
        ...
        htmltovue(components[i], container, compile, deploy, dialog, model, vue, nosampleempty, category)
    }
    if(compile) {
...
/**
   ...
   * @param {string} category - command argument that will tell whether to convert a component or object
*/
function htmltovue(name, container, compile, deploy, dialog, model, vue, nosampleempty, category) {
